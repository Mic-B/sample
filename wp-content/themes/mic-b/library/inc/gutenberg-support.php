...
function gutenbergtheme_scripts() {
	...
	wp_enqueue_script( 'gutenbergtheme-navigation', get_template_directory_uri() . '/library/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'gutenbergtheme-skip-link-focus-fix', get_template_directory_uri() . '/library/js/skip-link-focus-fix.js', array(), '20151215', true );
 ...
 */
require get_template_directory() . '/library/inc/template-functions.php';
